...
- <a href="#toc-001">一、支持向量机要解决的问题</a>
- <a href="#toc-002">二、直观理解支持向量机(SVM)</a>
  - <a href="#toc-003">间隔和决策边界</a>
  - <a href="#toc-004">正负超平面和决策超平面</a>
  - <a href="#toc-005">损失</a>
  - <a href="#toc-006">软间隔和硬间隔</a>
  - <a href="#toc-007">升维（维度转换）</a>
